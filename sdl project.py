...
def generate_bill():
    ...
    quantity=quantityVar.get()
    cost = costVar.get()
    conn = pymysql.connect(host="localhost", user="root", passwd="Sonar@123", db="billservice")
    cursor = conn.cursor()
...
def loginWindow():
    ...
    titleLabel = Label(window, text="Restaurent Bill & Inventory Management System", font=("Arial", 30), fg="black", bg='#FFD700', pady=10)
    titleLabel.grid(row=0, column=0, columnspan=4, padx=(40, 0), pady=(10, 0), sticky='ew')
    ...
    loginButton = Button(window, text="Login", width=20, height=2, command=lambda: adminLogin(), fg="white", bg="#4CAF50")
    loginButton.grid(row=4, column=2, columnspan=2, pady=10, sticky='ew')


def mainwindow():

    titleLabel = Label(window,text="Restaurent Bill & Inventory Management System",font="Arial 30",fg="black",bg="skyblue")
    titleLabel.grid(row=0,column=1,columnspan=3, padx=(40,0),pady=(10,0))

    addNewItem = Button(window, text="Add Item", width=15, height=2,fg="black",bg="pink" ,command=lambda: addItemListener())
    addNewItem.grid(row=1, column=0, padx=(10,0),pady=(10,0))

    updateItem = Button(window, text="Update Item", width=15, height=2,fg="black",bg="pink",command=lambda: moveToUpdate())
    updateItem.grid(row=1, column=1, padx=(10,0), pady=(10,0))

    showallEntry= Button(window, text="Show Bills", width=15, height=2,fg="black",bg="pink",command=lambda:movetoBills())
    showallEntry.grid(row=1, column=2, padx=(10,0), pady=(10,0))

    logoutBtn = Button(window, text = "Logout",width=15, height=2,fg="black",bg="pink",command=lambda:LogOut())
    ...
    itemDropDown.grid(row=2, column=1, padx=(10, 0), pady=(10, 0), sticky='ew')
    itemDropDown.configure(bg='#D3D3D3')
    ...
    buttonBill = Button(window, text="Add to List",width=15,fg="black",bg="pink",command=lambda:generate_bill())
    buttonBill.grid(row=3, column=4,padx=(5,0),pady=(10,0))

    billLabel=Label(window, text="Bills", font="Arial 15")
    ...
    generateBill = Button(window, text="Generate Bills",width=15,fg="black",bg="pink", command = lambda:print_bill())
...
def itemAddWindow():
    ...
    titleLabel = Label(window,text="Restaurant Bill and Inventory System", width= 40,font="Arial 30",fg="black",bg="skyblue")
    titleLabel.grid(row=0,column=3,columnspan=4, padx=(40,0),pady=(10,0))
...
def updateItemWindow():
    backButton = Button(window, text="Back" , command=lambda:readAllData())
    backButton.grid(row=0, column=1)
    titleLabel = Label(window,text="Restaurent bill & Inventory Management System", width=40,font="Arial 30",fg="black",bg="skyblue")
    titleLabel.grid(row=0,column=3,columnspan=4,pady=(10,0))
    ...
    AddItemButton = Button(window, text="Update Item", width=20, height=2, fg="black",bg="pink",command=lambda:updateItem())
    AddItemButton.grid(row=3, column=3,pady=(10,0))

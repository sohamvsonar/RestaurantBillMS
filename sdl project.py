...
def loginWindow():
    ...
    titleLabel = Label(window, text="Restaurant Bill & Inventory Management System", font=("Arial", 30), fg="black", bg='#FFD700', pady=10)
...
def mainwindow():
    ...
    titleLabel = Label(window,text="Restaurant Bill & Inventory Management System",font="Arial 30",fg="black",bg="skyblue")
...
def updateItemWindow():
    backButton = Button(window, text="Back" , command=lambda:readAllData())
    backButton.grid(row=0, column=1)
    titleLabel = Label(window,text="Restaurant bill & Inventory Management System", width=40,font="Arial 30",fg="black",bg="skyblue")
